...
"""
  ...
  Original script by kinova robotics  
"""
...
if __name__ == '__main__':
  try:
    ...
    # home robot
    if (nbJoints==6): 
      # do in two steps because doesn't always work otherwise
      moveJoint([-1.47, 3.00, 3.00, -0.09, 1.87, -2.23], prefix, nbJoints) 
      rospy.sleep(5)
      moveJoint([-1.47, 3.00, 4.82, -0.09, 1.87, -2.23], prefix, nbJoints)
    else:
